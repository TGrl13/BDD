...
try :
    database.append((Personne,1000))
    database.append((Catégorie_Administrative,15))
    database.append((Dossier_social,1000))
    database.append((Emplacement,500))
    database.append((Partenaire,500))
    database.append((Formation,1000))
    database.append((Réunion,50))
    database.append((Problématique,500))
    database.append((Agent_administratif,500))
    database.append((Rendez_vous,100))
    database.append((Document_administratif,100))
    database.append((Dispositif,100))
    database.append((Aide,50))
    database.append((Participer_formation,50))
    database.append((Participer_réunion_2,50))
    database.append((Participer_réunion_1,50))
    database.append((Associer_problématique,50))
